...
export const useGitCommands = (state: GitState, setters: GitSetters) => {
  ...
  const { setCommits, setBranches, setRemotes, setTags, setHead, setBranchLanes, setCommitCounter, setExplanation } = setters;
  ...
  }, [head, branches, commits, commitCounter, branchLanes, setCommits, setBranches, setHead, setCommitCounter, setExplanation]);
  ...
  const handleBranch = useCallback((branchName: string) => {
    ...
    return true;
  }, [branches, head, commits, branchLanes, setBranches, setBranchLanes, setExplanation]);
  ...
  const handleTag = useCallback((tagName: string) => {
    ...
    return true;
  }, [tags, head, branches, commits, setTags, setExplanation]);
  ...
  }, [head, branches, commits, commitCounter, branchLanes, setCommits, setBranches, setCommitCounter, setExplanation]);
  ...
  }, [head, branches, commits, handleCommit, setExplanation]);
  ...
  }, [head, branches, setRemotes, setExplanation]);
  ...
  }, [head, remotes, commits, commitCounter, setCommits, setRemotes, setCommitCounter, setExplanation]);
  ...
  }, [head, branches, remotes, commits, commitCounter, setBranches, setCommits, setCommitCounter, setExplanation]);
  ...
  }, [head, branches, commits, commitCounter, setCommits, setBranches, setHead, setCommitCounter, setExplanation]);
